...
!     File  np02lib.f
!
!     npTitle  npInit   npSpec   npMem
!     npSet    npSeti   npSetr
!     npGet    npGeti   npGetr
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

      subroutine npTitle( title )

      character
     &     title*30

!     ==================================================================
!     npTitle sets the title.
!     ==================================================================

      title  = 'N P O P T  7.5-1.1  (Jun 2015)'
!---------------123456789|123456789|123456789|--------------------------

      end ! subroutine npTitle
...
!     ==================================================================
     ...
     &     maxiu, maxiw, maxru, maxrw, npStatus, qpStatus, s1outpt
      character
     &     title*30
!     ------------------------------------------------------------------
...
!     ==================================================================
     ...
     &     Userrw(130)
      integer
     &     i, inform, iObjU, lencw, lenR, liwEst, lrwEst,
     &     llenrw, lleniw, llencw, lvlHes, m, maxcw, maxiw, maxrw,
     &     maxR, maxS, mQNmod, nCon, neJ, negCon, nextcw, nextiw,
     &     nextrw, nkx, nnCon, nnH, nnJac, nnObj, nnObjU, nnCol
!     ------------------------------------------------------------------
      parameter        (lencw     = 500)
      character      cw(lencw)*8
      character      cdummy*8
