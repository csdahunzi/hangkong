!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!     File  sn05wrpch.f  --- user-function interfaces for snOptCH.
!
!     s0fgCH
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!     ==================================================================
!     s0fgCH  is an funwrapper interface that calls the user-written
...
!     funmode  Task
!     -------  ----
!     5 (fgh)  Get fCon, fObj and known components of gCon, gObj
!              call userHv to define a new Lagrangian Hessian.
!
!     4 (-gh)  Get                known components of gCon, gObj
!              call userHv to define a new Lagrangian Hessian.
!              (fCon, fObj             are ignored).
!     3 (--h)  call userHv to define a new Lagrangian Hessian.
!              (fCon, fObj, gCon, gObj are ignored).
!     2 (fg-)  Get fCon, fObj and known components of gCon, gObj
!              (userHv is ignored).
!
!     1 (-g-)  Get known components of gCon and gObj.
!              (fCon, fObj and userHv are ignored).
!
!     0 (f--)  Get fObj, fCon.
!              (gCon, gObj and userHv are ignored).
!
!     If s0fgCH is called with minmax = 0 (feasible point only) then
...
!     ==================================================================
     ...
     &     FPonly, Scaled
      integer
     &     gotFD, gotG, gotGl, l, lG, lgConu, lgObju, lgSave, lvlScale,
     ...
     &            //' assumed constant.', iw, leniw )
         ...
         if (NonlinearObj) then
            ...
            if (FPonly) then
               ...
               supplied  = 0
               do l = 1, nnObjU
                  if (gObj(l) .ne. Gdummy) supplied = supplied + 1
               end do

               if ( FPonly ) then
                  write(str, 2010) nnObjU
                  call snPRNT( 3, str, iw, leniw )
               else
            ...
            if (supplied .lt. nnObj) iw(gotFD) = 1
            if (supplied .gt.     0) iw(gotG ) = 1
         end if
      end if
